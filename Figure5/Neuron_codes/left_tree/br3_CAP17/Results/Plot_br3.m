...
hgexport(gcf, 'Figure2E', hgexport('factorystyle'), 'Format', 'png','Resolution','500')
...
ylim([-60,-10])
legend('20PF','40PF','48PF','50PF','60PF','80PF')
hgexport(gcf, 'Figure2F', hgexport('factorystyle'), 'Format', 'png','Resolution','500')
...
hold off
xlim([0,120])
hgexport(gcf, 'Figure2D', hgexport('factorystyle'), 'Format', 'png','Resolution','500')

save('br3_CAP17.mat','nb_syn','v_peak_vtip','v_peak_vprox')
